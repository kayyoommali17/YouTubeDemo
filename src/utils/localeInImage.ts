const localeImage = {
  ...
  option: require('../assets/images/dots.png'),
  ...
  happyWomen: require('../assets/images/happy-woman-sunshine.png'),
  cahannelImage: require('../assets/images/portrait-photo-of-woman-718978_2.png'),
};
